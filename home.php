    ...
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          <h2>Features</h2>
          <p>We try to provide our loyal users a rich and soothing experience in their path of learning<br>We do our
            best ,but suggestions are welcomed</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-info">
            ...
            <p class="det-p">Donec et lectus bibendum dolor dictum auctor in ac erat. Vestibulum egestas sollicitudin
  ...
  <section id="courses" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          <h2>Courses</h2>
          <p>Thousands of courses are at your disposal!<br></p>
          <hr class="bottom-line">
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="course1.jpg" class="img-responsive">
            <figcaption>
              <h3>Javascript</h3>
              <p>Unlock the power of dynamic web development with our JavaScript course – from foundational concepts to
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="course2.jpg" class="img-responsive">
            <figcaption>
              <h3>React JS</h3>
              <p>Discover the future of front-end development with our React.js course – master the art of building
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="course3.jpg" class="img-responsive">
            <figcaption>
              <h3>Android Development</h3>
              <p>Embark on your journey into mobile app development with our Android Development course – learn to build
                powerful and innovative applications.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="course4.png" class="img-responsive">
            <figcaption>
              <h3>Angular JS</h3>
              <p>Explore Angular with our course – unlock the potential of modern web development, crafting dynamic and
                responsive applications effortlessly.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="course5.png" class="img-responsive">
            <figcaption>
              <h3>C++</h3>
              <p>Embark on a journey into the heart of programming with our C++ course – from foundational concepts to
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="course6.jpg" class="img-responsive">
            <figcaption>
              <h3>Jade</h3>
              <p>Master Jade with our course – streamline your HTML workflow, creating concise and expressive templates
                seamlessly.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <button class="mybutton" style="float: right;"><span><a href="courses.php"
              style='text-decoration:none;color:white;'>View More</a></span></button>
      </div>
    </div>
  </section>
