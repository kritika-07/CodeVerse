...
<body>
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li><a href="home.php#feature">Features</a></li>
  ...
  <div class="modal-dialog modal-sm" id="cform">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center form-title" style="color:white;">Payment Gateway</h4> <button type="button"
          class="close" data-dismiss="modal"><a href='http://localhost/ltc/courses.php'
            style='font-size: 30px;color:black;float:right;'>&times;</a></button>
      </div>
  ...
  <div id="coursecards" style= "margin-top: 30px; margin-bottom: 30px;">
    ...
    <div class="card">
      ...
      <p><button type="submit" id="javascript" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="reactjs" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card" id="coursecard">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="android" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="java" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <br><br>
    <!--    row2-->
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="angularjs" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="c++" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="jade" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="bootstrap" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    ...
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="php" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="web-ui" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card" id="coursecard">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="Nodejs" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="vue-js" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <br><br>
    ...
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="maven" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    ...
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="perl" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card" id="coursecard">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="chart-js" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <div class="card">
      ...
      <p class="title">CEO & Founder, Example</p>
      <p>Harvard University</p>
      <p><button type="submit" id="mongodb" onClick='showMessage(this.id)' style="color:black;">Buy</button></p>
    </div>
    <br><br>
  </div>
